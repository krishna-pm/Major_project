...
rf = RandomForestClassifier(n_estimators=30,criterion='entropy',random_state=100,max_depth=3)
xg = xgb.XGBClassifier(max_depth=12,n_estimators=500,learning_rate = 0.01)
dt = DecisionTreeClassifier(criterion = "entropy", random_state = 10,max_depth = 5, min_samples_leaf = 5)
