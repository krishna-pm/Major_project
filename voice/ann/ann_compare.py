...
model=Sequential()
###first layer
model.add(Dense(300,input_shape=(6372,)))
...
num_epochs = 90
num_batch_size = 32
checkpointer = ModelCheckpoint(filepath='./audio_classification_compare.hdf5', monitor='val_accuracy', mode='max', verbose=1, save_best_only=True)
start = datetime.now()
